    ...
    public class Game1 : Game
    {
        ...
        private void PotatoDebugging()
        {
            ...
            */
            ...
            enemy = new Enemy(new Rectangle(890,400, 75, 75), collisionTest, 16, 60);
            enemy2 = new Enemy(new Rectangle(400, 250, 75, 75), collisionTest, 4, 60);
            enemy3 = new Enemy(new Rectangle(400, 0, 75, 75), collisionTest, 4, 60, 5, 2, 100);
